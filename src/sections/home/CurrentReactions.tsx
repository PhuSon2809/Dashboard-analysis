...
const CurrentReactions = memo(() => {
  ...
  return (
    <div className='relative pt-[120px]'>
      ...
      <div className='relative z-10 flex w-full gap-28'>
        <div className='pl-[105px]'>
          ...
          <p className='mt-4 leading-[24px] text-grey999/[.64]'>
          ...
          <div className='mt-[47px] flex min-w-[472px] flex-col gap-[26px]'>
            {listTypePerson.map((type) => (
              <div
                key={type}
                onClick={() => setTypeActive(type)}
                className={classNames(
                  type === typeActive ? 'h-[164px] w-[472px] py-8' : 'h-[120px] w-[292px] cursor-pointer py-6',
                  'flex items-center justify-between rounded-3xl bg-grey100 px-6 transition-all duration-300 ease-in-out'
                )}
              >
        ...
        <div className='list-person w-[800px] pr-[97px] pt-[30px]'>
          <Swiper
            ref={swiperRef}
            loop
            grabCursor
