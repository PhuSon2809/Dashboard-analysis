// icon:paper-airplane-16 | Octicons https://primer.style/octicons/ | Github Primer
import * as React from 'react'

function IconPaperAirplane16(props: React.SVGProps<SVGSVGElement>) {
  return (
...
export default IconPaperAirplane16
