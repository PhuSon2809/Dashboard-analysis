...
const PurchasesChartMobile = memo(({ isSmall, isLittleSmall }: { isSmall?: boolean; isLittleSmall?: boolean }) => {
      ...
      >
        <PolarArea
          options={{
            ...
            plugins: {
              datalabels: {
                font: { size: isSmall ? 8 : isLittleSmall ? 14 : 20 },
                color: '#fff',
                anchor: 'center',
                align: 'center',
...
export default PurchasesChartMobile
