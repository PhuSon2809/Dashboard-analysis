const messages = [
  {
    id: 1,
    message: [
      `Total Revenue on August 12, 2024 is $1,000, decreasing 5% compared to the previous day.
    `
    ],
    type: 'ai',
    image: []
...
`
  ...
  },
  {
    id: 3,
    message: [
      `**Customer Reaction: Mostly unhappy customers.**
