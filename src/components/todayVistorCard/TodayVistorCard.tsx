...
const TodayVistorCard = memo(() => {
  ...
  return (
    <div className='relative flex h-[235px] w-full flex-shrink-0 items-center justify-center overflow-hidden rounded-[32px] bg-white/[.60] backdrop-blur-2xl lg:h-[300px] lg:w-[454px] lg:bg-white/[.44] lg:shadow-s-1'>
