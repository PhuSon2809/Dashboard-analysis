...
const TodayReportCard = ({ title, icon, data, color, isIncreasing = true }: TodayReportCard) => {
  return (
    <div className='relative flex h-[132px] w-[300px] sm:w-full flex-col items-start justify-between rounded-2xl bg-white/[.44] p-4 shadow-s-4 backdrop-blur-2xl lg:w-[202px]'>
