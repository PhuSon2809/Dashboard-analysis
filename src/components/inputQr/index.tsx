...
const UploadQR = memo(({ setCustomSeedphrase, setPriKey }: UploadQRProps) => {
  ...
  return (
    <div className='flex h-fit w-full flex-1 flex-col items-center gap-3'>
      <div className='flex h-fit w-full flex-col items-center gap-3 rounded-[8.4px] border-[2px] border-dotted border-blackMain/[.22] p-3'>
        <div className='flex min-h-[126px] p-5'>
          {imageToShow ? (
        ...
        <div className='flex w-full items-center gap-1 text-[14px] tracking-[1%]'>
          <button className='h-[33px] w-full rounded border-[1px] border-solid border-blackMain transition-all duration-150 ease-in-out hover:scale-[102%]'>
            Scan QR code
          </button>
